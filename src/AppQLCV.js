...
import './index.css';
import TaskForm from "./QLCV/TaskForm";
import Control from "./QLCV/Control";
import TaskList from "./QLCV/TaskList";
import { findIndex } from "lodash";
import demo from "./trainging-redux/demo";
class AppQLCV extends Component {
    ...
    render() {
        ...
        /> : ''; / / If isDisplayForm === true, show form
        for user
        if (filter.name) {
        ...
        return ( <
            ...
            div className = "row" >
            <
            div className = "col-xs-4 col-sm-4 col-md-4 col-lg-4" > { elementForm } <
            /div> <
